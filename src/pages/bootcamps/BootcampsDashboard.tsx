...
const BootcampsDashboard = () => {
  const sidebarItems = [
    { label: "Resumen", path: "/portal/bootcamps/overview", icon: <LayoutDashboard className="w-5 h-5" /> },
    { label: "Mis Bootcamps", path: "/portal/bootcamps/my-bootcamps", icon: <BookOpen className="w-5 h-5" /> },
    { label: "Crear Módulo", path: "/portal/bootcamps/create", icon: <Plus className="w-5 h-5" /> },
    { label: "Notificaciones", path: "/portal/bootcamps/notifications", icon: <Bell className="w-5 h-5" /> },
    { label: "Configuración", path: "/portal/bootcamps/settings", icon: <Settings className="w-5 h-5" /> },
  ];

  return (
    <DashboardLayout sidebarItems={sidebarItems} title="Portal de Bootcamps">
      <Routes>
